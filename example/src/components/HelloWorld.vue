<template>
  <div class="hello">
    ...
    <h3 @click="btnClick">Installed CLI Plugins</h3>
    <ul>
      <li>
        <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-babel" target="_blank">babel</a>
      </li>
      <li>
        <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-typescript" target="_blank">typescript</a>
      </li>
    </ul>
...
import { trackEvent } from '@monitor/collector-track'

@Component
export default class HelloWorld extends Vue {
  @Prop() private msg!: string
  bb = 123
  @trackEvent('btnClick', (vm: any) => ({ a: vm.bb }))
  btnClick() {
    console.log(123)
    // this.$trackEvent('ssas')
  }
}
</script>
