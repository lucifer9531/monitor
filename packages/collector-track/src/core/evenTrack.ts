import { isUndefined } from '@hutool/utils/lib/basicType/isUndefined'
import { JSONDecode, JSONEncode } from '@hutool/utils/lib/methods/json'
import { extend } from '@hutool/utils/lib/methods/object'
// @ts-ignore
import { SYSTEM_EVENTS } from '@monitor/collector-browser'
